...
# found in the LICENSE file.
{
  'variables': {
    ...
    'v8_compiler_sources': [
      ...
      '<(V8_ROOT)/src/compiler/decompression-elimination.cc',
      '<(V8_ROOT)/src/compiler/decompression-elimination.h',
      ...
      '<(V8_ROOT)/src/compiler/map-inference.cc',
      '<(V8_ROOT)/src/compiler/map-inference.h',
      ...
      '<(V8_ROOT)/src/compiler/write-barrier-kind.h',
  ...
  'targets': [
    ...
    }, # v8_compiler_for_mksnapshot
    {
      ...
      'sources': [
        ...
        '<(V8_ROOT)/src/api/api-arguments-inl.h',
        '<(V8_ROOT)/src/api/api-arguments.cc',
        '<(V8_ROOT)/src/api/api-arguments.h',
        '<(V8_ROOT)/src/api/api-natives.cc',
        '<(V8_ROOT)/src/api/api-natives.h',
        '<(V8_ROOT)/src/api/api.cc',
        '<(V8_ROOT)/src/api/api.h',
        ...
        '<(V8_ROOT)/src/date/date.cc',
        '<(V8_ROOT)/src/date/date.h',
        '<(V8_ROOT)/src/date/dateparser-inl.h',
        '<(V8_ROOT)/src/date/dateparser.cc',
        '<(V8_ROOT)/src/date/dateparser.h',
        ...
        '<(V8_ROOT)/src/heap/combined-heap.cc',
        '<(V8_ROOT)/src/heap/combined-heap.h',
        ...
        '<(V8_ROOT)/src/init/bootstrapper.cc',
        '<(V8_ROOT)/src/init/bootstrapper.h',
        '<(V8_ROOT)/src/init/icu_util.cc',
        '<(V8_ROOT)/src/init/icu_util.h',
        '<(V8_ROOT)/src/init/isolate-allocator.cc',
        '<(V8_ROOT)/src/init/isolate-allocator.h',
        '<(V8_ROOT)/src/init/setup-isolate.h',
        '<(V8_ROOT)/src/init/startup-data-util.cc',
        '<(V8_ROOT)/src/init/startup-data-util.h',
        ...
        '<(V8_ROOT)/src/msan.h',
        '<(V8_ROOT)/src/numbers/bignum-dtoa.cc',
        '<(V8_ROOT)/src/numbers/bignum-dtoa.h',
        '<(V8_ROOT)/src/numbers/bignum.cc',
        '<(V8_ROOT)/src/numbers/bignum.h',
        '<(V8_ROOT)/src/numbers/cached-powers.cc',
        '<(V8_ROOT)/src/numbers/cached-powers.h',
        '<(V8_ROOT)/src/numbers/conversions-inl.h',
        '<(V8_ROOT)/src/numbers/conversions.cc',
        '<(V8_ROOT)/src/numbers/conversions.h',
        '<(V8_ROOT)/src/numbers/diy-fp.cc',
        '<(V8_ROOT)/src/numbers/diy-fp.h',
        '<(V8_ROOT)/src/numbers/double.h',
        '<(V8_ROOT)/src/numbers/dtoa.cc',
        '<(V8_ROOT)/src/numbers/dtoa.h',
        '<(V8_ROOT)/src/numbers/fast-dtoa.cc',
        '<(V8_ROOT)/src/numbers/fast-dtoa.h',
        '<(V8_ROOT)/src/numbers/fixed-dtoa.cc',
        '<(V8_ROOT)/src/numbers/fixed-dtoa.h',
        '<(V8_ROOT)/src/numbers/math-random.cc',
        '<(V8_ROOT)/src/numbers/math-random.h',
        '<(V8_ROOT)/src/numbers/strtod.cc',
        '<(V8_ROOT)/src/numbers/strtod.h',
        ...
        '<(V8_ROOT)/src/objects/object-list-macros.h',
        ...
        '<(V8_ROOT)/src/objects/tagged-impl-inl.h',
        '<(V8_ROOT)/src/objects/tagged-impl.cc',
        '<(V8_ROOT)/src/objects/tagged-impl.h',
        ...
        '<(V8_ROOT)/src/parsing/literal-buffer.cc',
        '<(V8_ROOT)/src/parsing/literal-buffer.h',
